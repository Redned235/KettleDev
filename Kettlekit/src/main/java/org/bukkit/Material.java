...
public enum Material {
    ...
    public static Material addMaterial(int id, String name, boolean isBlock) {
        if (byId[id] == null) {
            ...
            Material material = addEnum(Material.class, materialName, new Class[]{Integer.TYPE, Boolean.TYPE}, new Object[]{id, isBlock});
            byId[id] = material;
    ...
    public static void setMaterialName(int id, String name, boolean flag) {
        ...
        if (byId[id] == null) {
            ...
            Material newMaterial = replaceEnum(Material.class, materialName, material.ordinal(), new Class[]{Integer.TYPE}, new Object[]{id});
            if (newMaterial == null)
    ...
    private static void setFailsafeFieldValue(Field field, Object target, Object value) throws Exception {
        ...
        Object fieldAccessor = newFieldAccessor.invoke(reflectionFactory, field, Boolean.FALSE);
    ...
    public static <T extends Enum<?>> T replaceEnum(Class<T> enumType, String enumName, int ordinal, Class<?>[] paramTypes, Object[] paramValues) {
        ...
        try {
            ...
            setFailsafeFieldValue(valuesField, null, values.toArray(new Object[0]));
